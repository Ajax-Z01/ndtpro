...
<body>
    ...
    <!-- loader end -->
    <header id="myHeader" class="topnav">
        <div class="container">
            <div class="header-bar">
                <a href="index.php"><img class="logo-header" src="assets/img/logo.png" alt="logo"></a>
                <nav class="navbar">
            ...
            <div class="mobile-nav hmburger-menu" id="mobile-nav" style="display:block; background-image: url(assets/img/background.png);">
                ...
                <ul>
                    ...
                    <li class="text-center"><a href="login.php" class="btn">Login</a></li>
                </ul>
                ...
                <div class="menu-sidebar-single-widget">
                    ...
                    <div class="header-contact-info">
                        ...
                        <span>
                            <a href="mailto:admin@ndtpro.com">
                                <i class="fa-solid fa-envelope"></i>admin@ndtpro.com
                            </a>
                        </span>
                        <span><a href="callto:+628994530875"><i class="fa-solid fa-phone"></i>+628994530875</a></span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 valign">
                        <div class="cont-info two">
                            <div class="about-sasnio bottom grid text-center">
                                <img class="logo-about" src="assets/img/logo-b-ori.png" alt="NDT Pro">
                                <h4>About NDT Pro Company</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed eius to incididu nt ut labore et dolore magna aliqua. Ut enims ad minim venimassa. Lorem ips um do lor sit amet,to mod te mpor incididunt</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 valign">
                        <div class="cont-info">
                            <div class="item mb-50">
                                ...
                                <p class="fw-400 fz-18">Runway East Borough Market, 20 St New town Street 2478, London</p>
                            </div>
                            <div class="item mb-50">
                                <h6 class="text-u fw-600 mb-20">HOW TO CONNECT</h6>
                                <p class="fw-400 fz-18"><a href="callto:+628994530875">+628994530875</a></p>
                                <p class="fw-400 fz-18"><a href="mailto:admin@ndtpro.com">admin@ndtpro.com</a></p>
                            </div>
                            <div class="bottom">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="hero-one-img">
                        <img src="assets/img/logo-ori.png" alt="hero-one-img">
                    ...
                    <div class="services">
                        <i>
                            <svg id="Line_Expand" enable-background="new 0 0 64 64" height="512" viewBox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="m32 32c-.256 0-.512-.098-.707-.293l-4-4 1.414-1.414 3.293 3.293 3.293-3.293 1.414 1.414-4 4c-.195.195-.451.293-.707.293z" />
                                <path d="m31 31h2v4h-2z" />
                                <path d="m31.949 48.018c-2.693 0-5.402-.677-7.858-2.068l.985-1.74c5.493 3.11 12.434 2.137 16.881-2.367 4.638-4.698 5.368-12.089 1.736-17.574l1.668-1.104c4.151 6.27 3.318 14.716-1.981 20.082-3.092 3.132-7.242 4.771-11.431 4.771z" />
                                <path d="m18.626 40.849c-4.15-6.27-3.317-14.716 1.981-20.083 5.083-5.149 13.02-6.258 19.295-2.7l-.986 1.74c-5.492-3.115-12.436-2.142-16.886 2.364-4.637 4.698-5.368 12.089-1.736 17.575z" />
                                <path d="m40.91 25.07-.707-4.949c-.045-.312.06-.626.283-.849.222-.223.533-.329.849-.283l4.95.707-.285 1.981-3.629-.519.518 3.629z" />
                                <path d="m22.808 45.021c-.047 0-.094-.003-.142-.01l-4.95-.707.284-1.981 3.629.519-.518-3.629 1.979-.283.707 4.949c.045.312-.06.626-.283.849-.188.188-.443.293-.706.293z" />
                            </svg>
                        </i>
                        <a href="#">Digital Strategies</a>
                        <p>Lorem ipsum dolor sit amet, cons ectetur adipiscing elit, sed do eiu smod tempor.</p>
                    </div>
                </div>
                <div class="col-lg-12 item">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="propel-img">
                        <img src="https://via.placeholder.com/636x449" alt="Propel">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="heading two">
                        <h6>SUSTAINABILITY IS OUR FOCUS</h6>
                        <h2>Propel Your Career & Expand Your Knowledge at Any Level</h2>
                    </div>
                    <div class="propel-text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,sed eius to incididunt ut labore et dolore magna aliqua. Ut enims ad minim veni massa. Lorem ipsum dolor sit amet,to mod tempor incididunt</p>
                        <div class="propel">
                            <div><i><img src="assets/img/propel-icon-1.png" alt="propel-icon"></i></div>
                            <div>
                                <h5>New Business Opportunities</h5>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                        <div class="propel">
    ...
    <div class="gap">
        <div class="container">
            <div class="trusted-by">
                <h5>600M Trusted by Top <span>Global Business Organizations</span></h5>
                <div class="logodata owl-carousel owl-theme">
                    <div class="partner item">
                        <img alt="clients-logo" src="https://via.placeholder.com/172x80">
                    </div>
                    <div class="partner item">
                        <img alt="clients-logo" src="https://via.placeholder.com/172x80">
                    </div>
    ...
    <section class="gap no-bottom projects" style="background-image: url(assets/img/background.png); background-color: #faf9f5;">
        <div class="container">
            <div class="heading">
                <img src="assets/img/heading-img.png" alt="heading-img">
            ...
            <div class="row companie owl-carousel owl-theme">
                <div class="col-lg-12 item">
                    <div class="projects-style">
                        <div class="projects-img">
                            <figure>
                                <img src="https://via.placeholder.com/400x360" alt="img">
                            </figure>
                            <a href="project-details-1.html"><i class="fa-solid fa-angle-right"></i></a>
                        </div>
                        <h4><a href="project-details-1.html">The Future Lifestyle Platform.</a></h4>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        ...
                        <div class="better-business">
                            <p>Lorem ipsum dolor sit amet, consectetur adipis icing elit,sed eius to incididunt ut labore et dolore magna aliqua. Ut enims ad minim venimassa. Lor em ipsum d olor sit amet,to mod tempor incididunt g elit,sed eiu eius to incididus to inci.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="business-img">
                            <img src="https://via.placeholder.com/670x528" alt="img">
    ...
    <section class="gap client-reviews">
        ...
        <img src="https://via.placeholder.com/84x84" class="quote-1" alt="img">
        <img src="https://via.placeholder.com/84x84" class="quote-2" alt="img">
        <img src="https://via.placeholder.com/84x84" class="quote-3" alt="img">
        <img src="https://via.placeholder.com/84x84" class="quote-4" alt="img">
        <img src="https://via.placeholder.com/84x84" class="quote-5" alt="img">
    </section>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="accordion">
                        <div class="accordion-item">
                            ...
                            <div class="content">
                                <p>Lorem Ipsum estibulum blandit libero at mauris condime ntummales uada scelerisque in mauris ut malesuada. Ute littellus, luctus estibulum blandit libero at manec.
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="accordio-img">
                        <img src="https://via.placeholder.com/565x611" alt="accordio-img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog img-hover ">
                        <div class="blog-img">
                            <figure>
                                <img src="https://via.placeholder.com/360x290" alt="blog">
                            </figure>
                        </div>
                ...
                <div class="button-center">
                    <a href="our-blog.html" class="btn">View All News</a>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="together">
                        ...
                        <p>Contact us and we’ll set up a video call to discuss your requirements in detail.</p>
                        <ul class="list">
                            <li><img src="assets/img/check.png" alt="check">Application design and Development</li>
                ...
                <div class="col-lg-6">
                    <div class="together-img">
                        <img src="https://via.placeholder.com/587x526" alt="Together">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="information">
                        ...
                        <a href="mailto:admin@ndtpro.com">admin@ndtpro.com</a>
                        <div class="d-flex">
                            <i class="fa-solid fa-location-dot"></i>
                            <h6>Runway East Borough Market, 20 St New town Street 2478, London</h6>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">Privacy Policy</a></li>
                            <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">App Download</a></li>
                            <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">How It Works</a></li>
                            <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">Terms & Conditions</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="copyrights">
                <div class="d-flex align-items-center">
                    ...
                    <div class="boder"></div>
                    <span>Phone No. <a href="callto:+628994530875">+628994530875</a></span>
                </div>
                <p>Copyright © <a href="/">NDT Pro</a> 2023. All Rights Reserved.</p>
            </div>
        </div>
        <img src="assets/img/dots-shaps.png" alt="dots-shaps" class="dots-shaps">
